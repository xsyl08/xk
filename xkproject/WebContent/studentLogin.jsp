...
<body style="background:url('images/2.jpg');background-size:cover">
	...
	<div id="dd" class="easyui-dialog" title="学生登录" style="width:500px;height:500px;" style="background:url('images/back.jpg');"  
        data-options="iconCls:'icon-man',resizable:true,modal:true">
    	<form action="studentController/studentLogin.action" method="post">
    		<table style="margin:auto;margin-top:50px;font-size:18px;">
                <tr>
                    <td style="width:80px;height:50px;">姓名：</td>
                    <td><input style="height:20px;" type="text" name="student_name"></input></td>
                </tr>
                <tr>
                    <td style="width:80px;height:50px;">密码：</td>
                    <td><input style="height:20px;" style="" type="password" name="student_pwd"></input></td>
                </tr>
                <tr>
